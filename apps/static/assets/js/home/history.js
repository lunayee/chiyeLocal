...
window.addEventListener("load", function() {
    ...
    var totalPage = 0;
    var now = moment()
    var stv = now.clone().add(-3, 'days').format("YYYY-MM-DD 00:00");
    ...
    exportbtn.addEventListener("click", function() {
        ...
        axios
        .get("/GetExport/",{params:{st:StartTime.value,et: EndTime.value,table: table1_0.value,SwitchCheck_all: SwitchCheck_all}})
        .then(function(resp){
            Toast.fire({
                icon: 'success',
                title: 'Export成功！'
